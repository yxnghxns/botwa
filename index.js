...
/////////////////
const BotName = 'CL6UT BOT☄'; 
const instagram = 'https://instagram.com/ryhndzky'; 
const telegram = 'https://t.me/itsyaboyhan'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/channel/UCFy7jwWuGvzQobVGvc99zyA';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@ryhndzky')
